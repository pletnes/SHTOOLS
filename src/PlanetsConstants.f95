...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	real*8, parameter ::	R_Moon = 1737028.375838570d0, &	! Average of ULCN2005 grid and poly spherical harmonic models
				...
				c_moi = 0.39320d0, &		! normalized polar moment of inertia (R=1738) Konopliv et al.
				i_moi = 0.39310d0, &		! average moment of inertia (R=1748) Konopliv et al.
				gamma_moi = 227.8710d-6, &	! (B-A)/C from LLR (Konopliv et al.)
	...
	real*8, parameter ::	GM_Mercury = 22032.090d9, &! Anderson et al. 1987 &
				R_Mercury = 2437.600d3, & ! Anderson et al. 1996
				Omega_Mercury = 2.0d0 *pi_constant / 87.96910d0 / 24.0d0 / 60.0d0 / 60.0d0 ! wikipedia
